...
function typeTranslate(type) {
  ...
  switch (type) {
    ...
    case 'any':
    case '*':
      result = types.tsTypeAnnotation(types.tsAnyKeyword());
      break;
    case 'number':
      result = types.tsTypeAnnotation(types.tsNumberKeyword());
      break;
    case 'string':
      result = types.tsTypeAnnotation(types.tsStringKeyword());
      break;
    case 'bool':
    case 'boolean':
    case 'true':
    case 'false':
      result = types.tsTypeAnnotation(types.tsBooleanKeyword());
      break;
    case '{}':
    case 'object':
      result = types.tsTypeAnnotation(types.tsObjectKeyword());
      break;
    case '[]':
    case 'array':
      result = type.tsTypeAnnotation(types.tsArrayType(types.tsAnyKeyword()));
      break;
    default:
      result = types.tsTypeAnnotation(types.tsTypeReference(types.identifier(type)));
      break;
  }
  return result;
}
